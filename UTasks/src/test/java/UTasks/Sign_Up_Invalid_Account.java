...
public class Sign_Up_Invalid_Account {
	...
	public void Sign_Up_Edge(WebDriver driver) {
		...
		try {
			...
			driver.findElement(Email_Text).sendKeys("utask1@test.com");
			...
			assertTrue(Message.getText().contains("Failed to create an account"));

		} catch (InterruptedException ex) {
			Logger.getLogger(Sign_Up_Invalid_Account.class.getName()).log(Level.SEVERE, null, ex);
		}
